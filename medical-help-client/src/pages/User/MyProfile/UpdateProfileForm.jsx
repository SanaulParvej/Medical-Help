        ...
        <form onSubmit={handleUpdateProfile} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-control">
              ...
              <select
                name="bloodGroup"
                defaultValue={userData?.bloodGroup || "Not Set"}
          ...
          <div className="form-control">
            <label className="label text-xs font-bold text-gray-500 uppercase">
              Disease / Allergies (If any)
            </label>
            <textarea
              name="chronicIllness"
              defaultValue={userData?.chronicIllness}
              className="textarea textarea-bordered w-full"
              placeholder="যেমন: ডায়াবেটিস, ধুলিকণায় এলার্জি..."
              rows="2"
            ></textarea>
          </div>
          ...
          <div className="modal-action">
            <button
              type="button"
              onClick={onClose}
              className="btn bg-gray-100 border-none text-gray-600 hover:bg-gray-200"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="btn bg-indigo-600 border-none text-white hover:bg-indigo-700 px-8 shadow-md"
            >
              Update Profile
            </button>
          </div>
