      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2">
            সম্পূর্ণ স্বাস্থ্যসেবা সমাধান আপনার হাতের মুঠোয়
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            <div
              key={service.id}
              className="card bg-base-100 shadow-xl border border-base-200  hover:scale-105 transition duration-300"
            >
              <div className="card-body items-center text-center">
                ...
                <div className="card-actions mt-2">
                  <Link to={service.link} className="btn btn-info btn-sm text-white">
                    বিস্তারিত
                  </Link>
                </div>
              </div>
