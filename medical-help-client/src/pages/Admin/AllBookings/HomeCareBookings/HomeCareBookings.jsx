...
const HomeCareBookings = () => {
  ...
  useEffect(() => {
    fetch("https://medical-help-server.vercel.app/homecare-bookings")
      .then((res) => res.json())
      .then((data) => {
        setBookings(data);
        setLoading(false);
        ...
        fetch(`https://medical-help-server.vercel.app/homecare-bookings/${id}`, {
          ...
          .then((data) => {
            if (data.modifiedCount > 0) {
              Swal.fire(
                "Approved!",
                "The Nursing Care Bookings has been approved.",
                "success",
              );
              setBookings((prev) =>
                prev.map((app) =>
        ...
        fetch(`https://medical-help-server.vercel.app/homecare-bookings/${id}`, {
          ...
          .then((data) => {
            if (data.modifiedCount > 0) {
              Swal.fire(
                "Cancelled!",
                "The Nursing Care Bookings has been cancelled.",
                "success",
              );
...
export default HomeCareBookings;
