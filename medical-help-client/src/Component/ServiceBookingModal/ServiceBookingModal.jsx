        ...
        <form onSubmit={handleBookService} className="space-y-4 pr-2">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500"
              placeholder="যেমন: স্ট্রোক, প্যারালাইসিস"
              required
            />
          </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={handleInputChange}
                  min="1"
                  className="w-1/2 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 text-center"
                  required
                />
                <select
                  name="durationUnit"
                  ...
                  onChange={handleInputChange}
                  className="w-1/2 px-2 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 bg-white"
                >
          ...
          <button
            type="submit"
            className="w-full py-3 bg-teal-600 hover:bg-teal-700 text-white font-bold rounded-lg shadow-md transition mt-4"
          >
            বুকিং কনফার্ম করুন
          </button>
        </form>
